...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	//	Если ЗначениеЗаполнено(ТекСтрокаДанные.Заявка) Тогда
	//		Если Не ТекСтрокаДанные.Заявка.ОтветственноеЛицо = Исполнитель Тогда
	//			Сообщить("Ошибка! В строке " + ТекСтрокаДанные.НомерСтроки + " выбранная заявка была записана на другое физическое лицо");
	//			Отказ = Истина;
	//		КонецЕсли;
	//	КонецЕсли;
	//КонецЦикла;
