...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	СведенияОбИспользованииККТ = УстановитьБит(СведенияОбИспользованииККТ,0,СведениеФФД1001АвтоматическийРежим);
	СведенияОбИспользованииККТ = УстановитьБит(СведенияОбИспользованииККТ,1,СведениеФФД1002АвтономныйРежим);
	СведенияОбИспользованииККТ = УстановитьБит(СведенияОбИспользованииККТ,2,СведениеФФД1056Шифрование);
	СведенияОбИспользованииККТ = УстановитьБит(СведенияОбИспользованииККТ,3,СведениеФФД1108Интернет);
	СведенияОбИспользованииККТ = УстановитьБит(СведенияОбИспользованииККТ,4,СведениеФФД1109РасчетыЗаУслуги);
	СведенияОбИспользованииККТ = УстановитьБит(СведенияОбИспользованииККТ,5,СведениеФФД1110БСО);
	СведенияОбИспользованииККТ = УстановитьБит(СведенияОбИспользованииККТ,6,СведениеФФД1126Лотереи);
	СведенияОбИспользованииККТ = УстановитьБит(СведенияОбИспользованииККТ,7,СведениеФФД1193АзартныеИгры);
	СведенияОбИспользованииККТ = УстановитьБит(СведенияОбИспользованииККТ,8,СведениеФФД1207ПодакцизныйТовар);
	СведенияОбИспользованииККТ = УстановитьБит(СведенияОбИспользованииККТ,9,СведениеФФД1221ПринтерВАвтомате);
	СведенияОбИспользованииККТ = УстановитьБит(СведенияОбИспользованииККТ,10,СведениеФФДЛомбарднаяДеятельность);
	СведенияОбИспользованииККТ = УстановитьБит(СведенияОбИспользованииККТ,11,СведениеФФДМаркировка);
	СведенияОбИспользованииККТ = УстановитьБит(СведенияОбИспользованииККТ,12,СведениеФФДСтраховаяДеятельность);
	Объект.СведенияОбИспользованииККТПоФФД = СведенияОбИспользованииККТ;
