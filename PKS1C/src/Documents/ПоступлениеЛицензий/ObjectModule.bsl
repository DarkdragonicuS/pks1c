...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Для Каждого Товар Из Товары Цикл
		Товар.КодАктивации = УдалитьПробельныеСимволы(Товар.КодАктивации);
		Товар.Серия = УдалитьПробельныеСимволы(Товар.Серия);
		Товар.РегистрационныйНомер = УдалитьПробельныеСимволы(Товар.РегистрационныйНомер);
	КонецЦикла;
КонецПроцедуры
