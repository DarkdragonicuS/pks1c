...
Функция ПолучитьДанныеВыбораКлиента(Текст,Контакт=Неопределено)	
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		СписокВыбора.Добавить(ВыборкаДетальныеЗаписи.Ссылка, ПодсветитьСлова(Строка(ВыборкаДетальныеЗаписи.Ссылка) + "(" + ВыборкаДетальныеЗаписи.Контрагент + ")",МассивСловПоиска));
	КонецЦикла;
