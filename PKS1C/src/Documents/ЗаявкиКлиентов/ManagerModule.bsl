...
Функция ПечатьАктаВызова(МассивОбъектов, ОбъектыПечати)
    ...
    |	ЗаявкиКлиентов.Дата Как ДатаЗаявки,
    ...
    Пока Шапка.Следующий() Цикл
        ...
        ПараметрыМакета.Вставить("ДатаЗаявки",Формат(Шапка.ДатаЗаявки,"ДФ='dd MMMM yyyy ""г.""';"));
        ПараметрыМакета.Вставить("ЗаявленнаяНеисправность",Шапка.ТекстЗаявки.Получить().ПолучитьТекст());
    	...
    	ОбластьСтрокиАкта = Макет.ПолучитьОбласть("СтрокиАкта");
    	ЗаполнитьЗначенияСвойств(ОбластьСтрокиАкта.Параметры,ПараметрыМакета);
    	ТабличныйДокумент.Вывести(ОбластьСтрокиАкта);
