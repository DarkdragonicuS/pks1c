...
Процедура ОбработатьШтрихкоды(ДанныеШтрихкода)
	...
	//<ПК-Сервис>
	Номенклатура = НоменклатураПоКодуАктивацииЛицензии(ПараметрыОбработки, КэшированныеЗначения);
...
//<ПК-Сервис>
&НаСервереБезКонтекста
Функция НоменклатураПоКодуАктивацииЛицензии(ПараметрыОбработки, КэшированныеЗначения)
	Номенклатура = Неопределено;
	ДанныеЛицензии = АутсорсЛицензииВызовСервера.ПолучитьДанныеЛицензииПоКодуАктивации(ПараметрыОбработки.Штрихкоды.Штрихкод);
	Если ЗначениеЗаполнено(ДанныеЛицензии) Тогда
		Номенклатура = ДанныеЛицензии.Номенклатура;
	КонецЕсли;
