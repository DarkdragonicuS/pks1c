...
Процедура ВыполнитьЗаписьСобытияПоЭДВЖурналРегистрации(ОписаниеСобытия, КодСобытия, УровеньВажности = Неопределено,
	...
	Если КодСобытия = "ЭлектронноеВзаимодействие" Тогда
		Подсистема = НСтр("ru = 'Общая подсистема'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	ИначеЕсли КодСобытия = "ОбменСБанками" Тогда
		Подсистема = НСтр("ru = 'Обмен с банками'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	ИначеЕсли КодСобытия = "ОбменСКонтрагентами" Тогда
		Подсистема = НСтр("ru = 'Обмен с контрагентами'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	ИначеЕсли КодСобытия = "ОбменССайтами" Тогда
		Подсистема = НСтр("ru = 'Обмен с сайтами'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	ИначеЕсли КодСобытия = "РегламентныеЗадания" Тогда
		Подсистема = НСтр("ru = 'Регламентные задания'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	ИначеЕсли КодСобытия = "БизнесСеть" Тогда
		Подсистема = НСтр("ru = 'Бизнес-сеть'",	ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	ИначеЕсли КодСобытия = "ТорговыеПредложения" Тогда
		Подсистема = НСтр("ru = 'Торговые предложения'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	ИначеЕсли КодСобытия = "ИнтеграцияСЯндексКассой" Тогда
		Подсистема = НСтр("ru = 'Интеграция с Яндекс Кассой'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	Иначе
		Подсистема = НСтр("ru = 'Общая подсистема'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	КонецЕсли;
