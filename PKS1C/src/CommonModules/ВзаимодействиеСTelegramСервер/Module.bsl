...
// 
// Параметры:
//  Подкоманда - Число - определяет следующее действие команды: Неопределено - вывод клиентов для выбора, 1 - вывод номенклатуры для выбора, 2 - вывод реализация для выбора
