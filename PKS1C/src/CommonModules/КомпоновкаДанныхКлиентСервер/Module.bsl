...
Функция ИспользуемыеОтборыРавны(ИсточникОтбор, ЭлементСравненияОтбор) Экспорт
	...
	Если ИсточникОтбор = Неопределено И ЭлементСравненияОтбор = Неопределено Тогда
		Возврат Истина;
	КонецЕсли;
	...
	Для Каждого ЭлементОтбора Из ИсточникОтбор.Отбор.Элементы Цикл
		...
		Если НЕ ЕстьТакойжеОтбор(ЭлементОтбора, ЭлементСравненияОтбор.Отбор.Элементы, НайденныйЭлемент) Тогда
			Возврат Ложь;
		КонецЕсли;
	...
	Для Каждого ЭлементОтбора Из ЭлементСравненияОтбор.Отбор.Элементы Цикл
		НайденныйЭлемент = Неопределено;
		Если НЕ ЕстьТакойжеОтбор(ЭлементОтбора, ИсточникОтбор.Отбор.Элементы, НайденныйЭлемент) Тогда
			Возврат Ложь;
		КонецЕсли;
		Если ТипЗнч(ЭлементОтбора) = Тип("ГруппаЭлементовОтбораКомпоновкиДанных") Тогда
			Если НЕ ИспользуемыеОтборыРавны(ЭлементОтбора.Элементы, НайденныйЭлемент) Тогда
