...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	//2023.08.30
	Раздел = Разделы.Добавить();
    Раздел.Имя  = "Аутсорсинг";
    Раздел.Идентификатор = Новый УникальныйИдентификатор("7149aa6c-46c7-11ee-9d93-5cf3708378b2");
    Раздел.Представление = НСтр("ru = 'Аутсорсинг'");
    Раздел.ТипыОбъектов.Добавить(Тип("СправочникСсылка.ФизическиеЛица"));
	//</ПК-Сервис>
...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	//iss065
	//2023.08.30
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,Метаданные.Документы.ДневнойОтчетПочасовыхРабот.ПолноеИмя(),
        "Дата", "Аутсорсинг", "Исполнитель");
    ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,Метаданные.РегистрыСведений.ПочасовыеРаботы.ПолноеИмя(),
        "Период", "Аутсорсинг", "Исполнитель");
	//</ПК-Сервис>
