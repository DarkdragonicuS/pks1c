...
Процедура РассчитатьПартииПрочих(НачалоПериода, ОкончаниеПериода, МассивОрганизаций, КоличествоЗаписей = 0)
	...
	ВосстановитьДвиженияДокументовПоПартииПрочихРасходов(НачалоПериода, ОкончаниеПериода, МассивОрганизаций);
...
Функция ДанныеДляПартийПрочих(НачалоПериода, ОкончаниеПериода, МассивОрганизаций)
	...
	ЗапросРасчетаЗаказов.УстановитьПараметр("УчитыватьНазначение", ПолучитьФункциональнуюОпцию("УчитыватьСебестоимостьТоваровПоВидамЗапасов"));
...
Процедура ВосстановитьДвиженияПоСебестоимостиТоваровСформированныеВВерсииПУ22(НачалоПериода, ОкончаниеПериода, МассивОрганизаций) Экспорт
	...
	Запрос.УстановитьПараметр("ТипыЗаписейКонвертацииДанных",
		УниверсальныеМеханизмыПартийИСебестоимости.ТипыЗаписейКонвертацииДанных());
...
#Область РегистрНакопления_ПартииПрочихРасходов

Процедура ВосстановитьДвиженияДокументовПоПартииПрочихРасходов(НачалоПериода, ОкончаниеПериода, МассивОрганизаций) Экспорт
	...
	ПараметрыОтбораДокументовЗапросаСтатьиНаПроизводственныеЗатратыВРегистреПартииПрочихРасходов(Запрос);
	...
	Запрос.Текст =
		ТекстЗапросаСтатьиНаПроизводственныеЗатратыВРегистреПартииПрочихРасходов()
		+ "
		|;
		|ВЫБРАТЬ
		|	Т.Ссылка,
...
Функция ТекстЗапросаСтатьиНаПроизводственныеЗатратыВРегистреПартииПрочихРасходов() Экспорт
	Возврат
		...
		|ИЗ
		|	ВТДвижения КАК Т
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТУчетныеПолитикиОрганизаций КАК УчетнаяПолитика
...
Процедура ПараметрыОтбораДокументовЗапросаСтатьиНаПроизводственныеЗатратыВРегистреПартииПрочихРасходов(Запрос) Экспорт
	...
	ТипыРегистраторов = УниверсальныеМеханизмыПартийИСебестоимости.ТипыДокументовОСиНМА();
...
Процедура ВременнаяТаблицаДанныхПоОтбору(ПолеОтбора, ТекстСортировка, Таблица, МВТ)
	...
	ПараметрыРасчета.Вставить("ВерсияПлатформыНеНиже8_3_13", УниверсальныеМеханизмыПартийИСебестоимости.ВерсияПлатформыНеНижеУказанной("8.3.13.0"));
