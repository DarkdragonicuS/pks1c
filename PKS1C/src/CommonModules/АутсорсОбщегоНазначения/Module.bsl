...
Функция ЗапросЦен(Организация, Дата) Экспорт		
	...
	|ИЗ
	|	РегистрСведений.ДоговораОбслуживания.СрезПоследних(&Дата, СрокДействия > &Дата
	|	ИЛИ СрокДействия = ДАТАВРЕМЯ(1, 1, 1, 0, 0, 0)) КАК ДоговораОбслуживанияСрезПоследних
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ДоговораОбслуживания.СрезПоследних(&Дата,) КАК
	|			ДоговораОбслуживанияСрезПоследних1
